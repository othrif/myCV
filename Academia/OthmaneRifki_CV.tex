...
\vspace{3mm}
\section{Presentations at International Conferences} % Public
\begin{tabular}{rp{15.5cm}}
...
\textsc{Jun. 2016}    & {\bf 4$^{\mathrm{th}}$ Large Hadron Collider Physics Conference} \hfill Lund, Sweden \\
            ...
            % using leptons or multiple b-jets with $3.2\ \mathrm{fb}^{-1}$ of $pp$ collisions at $\sqrt{s} = 13\ \mathrm{TeV}$
