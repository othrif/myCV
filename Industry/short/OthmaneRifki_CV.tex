...
\item Explained and authored complex research work to general audience; see an example \href{http://atlas.cern/updates/physics-briefing/probing-dark-matter-higgs-boson}{\bluelink{here}}
...
\item Developed the main data analysis software framework (for 50+ people) relying upon {\bf version control} and {\bf issue tracking} tools
\end{itemize}}%
}
