...
\item Helped {\bf refute} one of the most promising hypotheses on the nature of dark matter (85\% of the mass of the universe), by analyzing 10 million billion proton collisions in complex and high dimensional data
...
\item Supervised a team of 10 scientists and rotated on-call responsibility to achieve a {\bf data recording efficiency of 95\%}
\end{itemize}}%
}
...
\item Authored {\bf complex research work} for general audience; see an example \href{http://atlas.cern/updates/physics-briefing/probing-dark-matter-higgs-boson}{\bluelink{here}}
