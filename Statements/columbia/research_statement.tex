...
%The rate of invisible Higgs boson decays could be significantly enhanced beyond its SM value of $\sim0.1\%$ if the Higgs boson acts as a portal to DM, a reasonable assumption given that the Higgs boson couples to massive particles and that indirect constraints allow up to 34\% of the Higgs width to come from BSM decays.
%(Jonas Lindert, Marek Schoenherr, Stefano Pozzorini)
